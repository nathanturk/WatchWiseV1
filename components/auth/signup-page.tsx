      ...
      <Card className="w-full max-w-md card-gradient">
        <CardHeader className="text-center space-y-4 pb-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-400">
              Let's optimize your channel's performance with powerful insights and analytics tailored for your team.
            </p>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center text-sm text-gray-400">
            ...
            <Link href="/auth/signin" className="text-orange-500 hover:text-orange-400">
              Sign in
            </Link>
          </div>
